    ...
    return (
        <React.Fragment>
            ...
            <tr>
                ...
                <td><ColorPicker onUpdate={(background_color) => props.onUpdate('background_color', background_color)} /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><ColorPicker onUpdate={(color) => props.onUpdate('border_color', color)} /></td>
            </tr>

            <tr>
                <th scope="row">Button Hover Text Color</th>
                <td><ColorPicker onUpdate={(color) => props.onUpdate('hover_textcolor', color)} /></td>
            </tr>

            <tr>
                <th scope="row">Button Hover Background Color</th>
                <td><ColorPicker onUpdate={(color) => props.onUpdate('hover_background_color', color)} /></td>
            </tr>

            <tr>
                <th scope="row">Button Hover Border Color</th>
                <td><ColorPicker onUpdate={(color) => props.onUpdate('hover_border_color', color)} /></td>
            </tr>
        </React.Fragment>
    );
};
