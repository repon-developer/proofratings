<?php $overall_rectangle = get_proofratings_overall_rectangle(); ?>
<table class="form-table">
	...
	<tr>
		...
		<td>
			<label>
				<input name="proofratings_overall_rectangle[float]" value="no" type="hidden">
				<input class="checkbox-switch checkbox-float-embed" name="proofratings_overall_rectangle[float]" value="yes" type="checkbox" <?php checked( 'yes', $overall_rectangle['float'] ) ?>>
	...
	<tr id="badge-tablet-visibility">
		...
		<td>
			<label>
				<input name="proofratings_overall_rectangle[tablet]" value="no" type="hidden">
				<input class="checkbox-switch" name="proofratings_overall_rectangle[tablet]" value="yes" type="checkbox" <?php checked( 'yes', $overall_rectangle['tablet'] ) ?>>
	...
	<tr id="badge-mobile-visibility">
		...
		<td>
			<label>
				<input name="proofratings_overall_rectangle[mobile]" value="no" type="hidden">
				<input class="checkbox-switch" name="proofratings_overall_rectangle[mobile]" value="yes" type="checkbox" <?php checked( 'yes', $overall_rectangle['mobile'] ) ?>>
	...
	<tr id="badge-close-options">
		...
		<td>
			<label>
				<input name="proofratings_overall_rectangle[close_button]" value="no" type="hidden">
				<input class="checkbox-switch" name="proofratings_overall_rectangle[close_button]" value="yes" type="checkbox" <?php checked( 'yes', $overall_rectangle['close_button'] ) ?>>
			</label>
		</td>
	</tr>
	...
	<tr id="badge-position">
		...
		<td>
			<select name="proofratings_overall_rectangle[position]" data-position="<?php echo @$overall_rectangle['position']; ?>">
	...
	<tr>
		<td style="padding-left: 0" colspan="2">
			<label><input name="proofratings_overall_rectangle[customize]" class="checkbox-switch checkbox-yesno" value="yes" type="checkbox" <?php checked( 'yes', $overall_rectangle['customize']) ?>> Customize</label>
		</td>
	</tr>
	...
	<tbody id="overall-ratings-customize-options" style="display: none">
		<tr>
			...
			<td>
				<input class="proofratings-color-field" type="text" 
					name="proofratings_overall_rectangle[star_color]"
		...
		<tr id="badge-hide-shadow">
			...
			<td>
				<input name="proofratings_overall_rectangle[shadow]" value="no" type="hidden">
				<input class="checkbox-switch" name="proofratings_overall_rectangle[shadow]" value="yes" type="checkbox" <?php checked( 'yes', $overall_rectangle['shadow'] ) ?>>
			</td>
		</tr>
		...
		<tr id="badge-shadow-color">
			...
			<td>
				<input class="proofratings-color-field" type="text" 
					name="proofratings_overall_rectangle[shadow_color]"
		...
		<tr id="badge-shadow-hover-color">
			...
			<td>
				<input class="proofratings-color-field" type="text" 
					name="proofratings_overall_rectangle[shadow_hover]"
		...
		<tr>
			...
			<td>
				<input class="proofratings-color-field" type="text" 
					name="proofratings_overall_rectangle[background_color]" 
		...
		<tr>
			...
			<td>
				<input class="proofratings-color-field" type="text" 
					name="proofratings_overall_rectangle[review_text_color]" 
		...
		<tr>
			...
			<td>
				<input class="proofratings-color-field" type="text" 
					name="proofratings_overall_rectangle[review_background]" 
...
<table id="floating-badge-pages" class="form-table">
	...
	<tr>
		...
		<?php
			...
			printf('<input name="proofratings_overall_rectangle[pages][%s]" value="no" type="hidden">', $page->ID);
			printf(
				'<label><input class="checkbox-switch" name="proofratings_overall_rectangle[pages][%s]" value="yes" %s type="checkbox"></label>',
				$page->ID, $checked
			);
		?>
		</td>
